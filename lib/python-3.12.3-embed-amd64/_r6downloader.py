...
manifestList = {
    "Y1S0" : ["r6_y1s0_377237", "r6_y1s0_359551", "8358812283631269928 3893422760579204530",0, "初代 | 14.2 GB ", "Plazas\\PLAZA_BO", 7, 0, "RainbowSixGame.exe"],
    "Y1S1" : ["r6_y1s1_377237", "r6_y1s1_359551", "5188997148801516344 7932785808040895147",0, "墨冰行动 | 16.7 GB ", "Plazas\\PLAZA_BO", 7, 0, "RainbowSixGame.exe"],
    "Y1S2" : ["r6_y1s2_377237", "r6_y1s2_359551", "2303064029242396590 2206497318678061176",0, "尘土战线 | 20.9 GB ", "Plazas\\PLAZA_BO", 7, 0, "RainbowSixGame.exe"],
    "Y1S3" : ["r6_y1s3_377237", "r6_y1s3_359551", "5819137024728546741 5851804596427790505",0, "骷髅雨 | 25.1 GB ", "Plazas\\PLAZA_BO", 7, 0, "RainbowSixGame.exe"],
    "Y1S4" : ["r6_y1s4_377237", "r6_y1s4_359551", "3576607363557872807 8569920171217002292",0, "赤鸦行动 | 28.5 GB ", "Plazas\\PLAZA_BO", 7, 0, "RainbowSixGame.exe"],
    "Y2S1" : ["r6_y2s1_377237", "r6_y2s1_359551", "2248734317261478192 8006071763917433748",0, "丝绒壳行动 | 33.2 GB ", "Plazas\\PLAZA_NEW", 7, 0, "RainbowSixGame.exe"],
    "Y2S2" : ["r6_y2s2_377237", "r6_y2s2_359551", "5875987479498297665 708773000306432190",0, "健康行动 | 34 GB ", "Plazas\\PLAZA_NEW", 7, 0, "RainbowSixGame.exe"],
    "Y2S3" : ["r6_y2s3_377237", "r6_y2s3_359551", "6708129824495912434 1613631671988840841",0, "血兰花行动 | 34.3 GB ", "Plazas\\PLAZA_NEW", 7, 0, "RainbowSixGame.exe"],
    "Y2S4" : ["r6_y2s4_377237", "r6_y2s4_359551", "8748734086032257441 4221297486420648079",0, "白噪声行动 | 48.7 GB ", "Plazas\\PLAZA_NEW", 7, 0, "RainbowSixGame.exe"],
    "Y3S1" : ["r6_y3s1_377237", "r6_y3s1_359551", "5071357104726974256 4701787239566783972",0, "奇美拉行动 | 58.8 GB ", "Plazas\\PLAZA_NEW", 7, 0, "RainbowSixGame.exe"],
    "Y3S2" : ["r6_y3s2_377237", "r6_y3s2_359551", "6507886921175556869 8765715607275074515",0, "备战行动 | 63.3 GB ", "Plazas\\PLAZA_NEW", 7, 0, "RainbowSixGame.exe"],
    "Y3S3" : ["r6_y3s3_377237", "r6_y3s3_359551", "5562094852451837435 7781202564071310413",0, "暗空行动 | 72.6 GB ", "Plazas\\PLAZA_NEW", 7, 0, "RainbowSixGame.exe"],
    "Y3S4" : ["r6_y3s4_377237", "r6_y3s4_359551", "6502258854032233436 7659555540733025386",0, "风城行动 | 76.9 GB ", "Plazas\\PLAZA_NEW", 7, 0, "RainbowSixGame.exe"],
    "Y4S1" : ["r6_y4s1_377237", "r6_y4s1_359551", "8356277316976403078 5935578581006804383",0, "燃烧地平线 | 59.7 GB ", "Plazas\\PLAZA_NEW", 7, 0, "RainbowSixGame.exe"],
    "Y4S2" : ["r6_y4s2_377237", "r6_y4s2_359551", "693082837425613508 5408324128694463720",0, "幻镜行动 | 67.1 GB ", "Plazas\\PLAZA_NEW", 7, 0, "RainbowSixGame.exe"],
    "Y4S3" : ["r6_y4s3_377237", "r6_y4s3_359551", "3546781236735558235 7869081741739849703",0, "余烬重燃行动 | 69.6 GB ", "Plazas\\PLAZA_NEW", 7, 0, "RainbowSixGame.exe"],
    "Y4S4" : ["r6_y4s4_377237", "r6_y4s4_359551", "299124516841461614 1842268638395240106",0, "幻变潮汐行动 | 75.2 GB ", "Plazas\\PLAZA_NEW", 7, 0, "RainbowSixGame.exe"],
    "Y5S1" : ["r6_y5s1_377237", "r6_y5s1_359551", "4736360397583523381 6296533808765702678",0, "虚空边境行动 | 74.3 GB ", "Plazas\\PLAZA_NEW", 7, 0, "RainbowSixGame.exe"],
    "Y5S2" : ["r6_y5s2_377237", "r6_y5s2_359551", "4367817844736324940 893971391196952070",0, "钢流行动 | 81.3 GB ", "Plazas\\PLAZA_NEW", 7, 0, "RainbowSixGame.exe"],
    "Y5S3" : ["r6_y5s3_377237", "r6_y5s3_359551", "85893637567200342 3089981610366186823",0, "暗影传承行动 ", "Plazas\\CPlay", 12, 0, "RainbowSix.bat"],
    "Y5S4" : ["r6_y5s4_377237", "r6_y5s4_359551", "3390446325154338855 6947060999143280245",0, "霓虹黎明行动（联机猎恐）", "Plazas\\CPlay", 12, 0, "RainbowSix.bat"],
...
def Help():
    print(
                '''
                ----功能 1《彩虹六号-围攻》国内下载器     (从国内 Steam 服务器中下载，速度较快，Y6S1之前免登录Steam)
                ----功能 2《彩虹六号-围攻》海外下载器     (从海外 Steam 服务器中下载，速度一般，所有赛季免登录Steam)
...
def DownloadPatch(_version, _gamePath):
    try:
        print("如上述出现 Connection to Steam Failed. Trying again 和 Error 字样请开启UU加速器 路由模式加速 Steam商店|全部分区 后重试！")
        ...
        print("\nSteam服务器连接失败！请开启UU加速器 路由模式加速 Steam商店|全部分区 后重试！！！")
        print("Steam服务器连接失败！请开启UU加速器 路由模式加速 Steam商店|全部分区 后重试！！！")
        print("Steam服务器连接失败！请开启UU加速器 路由模式加速 Steam商店|全部分区 后重试！！！")
        print(e)
        ...
        if _gamePath.count(_version) > 1:
            ...
            if manifestList[_version][3]:
                ...
                if _first:
                    ...
                    os.system("lib\\DepotDownloader.exe -app 359550 -depot 377237 359551 -manifest "+manifestList[_version][2]+" -validate -dir "+_gamePath+" -user "+steamUser+" -pass "+steamPass)
                    print("游戏文件完整性验证完毕！")
            else:
                if _first:
